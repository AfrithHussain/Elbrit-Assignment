      ...
      <div className="blue-color h-[1000px]  md:h-[800px] mt-5 w-[95%] mx-auto">
               ...
               <div className="flex justify-evenly items-center mt-20 lg:mt-14  flex-wrap gap-y-20 gap-x-10 ">
                  ...
                  <div className="flex flex-col gap-2 lg:translate-y-4">
                      ...
                      & Minerals</p>
                      <button className='bg-[#17414F] text-white text-sm p-2 px-7 rounded-full mt-3 active:bg-teal-900 active:transition-all'>EXPLORE</button>
                  </div>
                  ...
                  <div className="bg-[#FFE9B5] w-60 h-60 radius">
                       <LazyLoadImage wrapperProps={{ style: {transitionDelay: "0.1s"}}} effect='blur' src={Probiotic} className=' cursor-pointer -translate-y-10 ' alt="" />
                  ...
                  <div className="lg:translate-y-10">
                      <div className="flex items-center gap-4   ">
                          <LazyLoadImage wrapperProps={{ style: {transitionDelay: "0.1s"}}} effect='blur' src={Pill} className='w-14 cursor-pointer'   alt="" />
                          <div className="">
                      ...
                      <div className="flex  items-center mt-5 gap-4">
                          <LazyLoadImage wrapperProps={{ style: {transitionDelay: "0.1s"}}} effect='blur' className='w-14 cursor-pointer' src={Weightscale} alt="" />
                         <div className="">
                      ...
                      <div className="flex items-center mt-5 gap-4">
                          <LazyLoadImage wrapperProps={{ style: {transitionDelay: "0.1s"}}} effect='blur'  className='w-14 cursor-pointer' src={Powder} alt="" />
                          <div className="">
